...
async function PartnerTopupToken(driver) {
    await driver.get('https://stag.indo.rentals/partner/topup')
    await driver.findElement(By.id("token")).sendKeys(Key.chord(Key.COMMAND,"a"))
    ...
    var btnSubmitPayment = await driver.findElement(By.css("button[type='submit']"))
    await driver.executeScript("arguments[0].click();", btnSubmitPayment)
    
    await driver.sleep(3000)
    var btnCheckPayment = await driver.findElement(By.css("button[type='submit']"))
