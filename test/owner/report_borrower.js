...
async function ReportBorrower(driver) {
    ...
    await driver.sleep(TIME_1000)
    await driver.findElement(By.xpath("//button[@data-bs-target='#detailModalReport']")).click()
    await driver.sleep(TIME_1000)
    await driver.findElement(By.id("report")).sendKeys("Selenium Automation Testing for Report Borrower")
    await driver.findElement(By.name("report_file")).sendKeys('/Users/radensaleh/Documents/Image Testing/mobil.jpeg')
    await driver.sleep(TIME_1000)
