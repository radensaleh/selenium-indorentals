...
async function RegisterOwnerLink(driver) {
    await driver.get('https://stag.indo.rentals/owner/register/face-verification/1684489341JVarM1XMmc0vjL7bjWmr')
    ...
    await driver.sleep(TIME_1000)
    var base64_txt = fs.readFileSync("./borrower/base64_liveness.txt").toString('utf-8')
    ...
    await driver.findElement(By.xpath("//input[@id='businessName']")).sendKeys('Mandiri Rental Jaya')
    ...
    await driver.findElement(By.xpath("//input[@id='email']")).sendKeys(`selenium.bylink${randInt}@gmail.com`)
